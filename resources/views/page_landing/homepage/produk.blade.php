<section class="min-w-full" id="produk">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-6 gap-4 md:px-10 hover:overflow-y-hidden">
        @for ($i = 1; $i <= 6; $i++)
            <div class="rounded-lg hover:shadow-md hover:overflow-y-hidden transition-transform transform md:px-10 hover:scale-105 overflow-hidden">
