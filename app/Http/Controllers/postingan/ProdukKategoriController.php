...
class ProdukKategoriController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('page_postingan.produkkategori.index', compact('produkkategoris'))->with('i', (request()->input('page', 1) - 1) * 10);
    }

    public function create(): View
    {
        return view('page_postingan.produkkategori.form');
    }
    ...
    {
        return view('page_postingan.produkkategori.edit', compact('produkkategori'));
    }
